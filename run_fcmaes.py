...
def main():
    #problem
    parser=argparse.ArgumentParser(description="Black box optimization - FCMAES") 
    ...
    parser.add_argument('--n_individuals',type=int,default=50,required=True,help="Number of individuals in the population (default:50)")
...
#  python .\run_fcmaes.py --cost_function paraboloid --ndim_problem 3 --upper_bound 100 --lower_bound -100 --max_evals 1000 --n_individuals 5 --sigma 0.5
